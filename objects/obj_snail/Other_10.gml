...
//if(newElevation != "oob"){ // commented out b/c never going to be out of bounds as long as we check for it
	...
	snugLedges( sign( mouse_x-self.x)*self.itemReach, //sprite_get_width (self.elevationCandidate.sprite_index), 
				sign(-mouse_y+self.y)*self.itemReach, //sprite_get_height(self.elevationCandidate.sprite_index), 
