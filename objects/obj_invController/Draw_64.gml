...
draw_text(0,view_hport-515, "Right-click an item to pick up. Press [1-4] to select item. Press 'Q' to drop selected item.");
draw_text(0,view_hport-545, "can drop here: "+string(self.canDropItemHere));
draw_text(0,view_hport-530, "can combine here: "+string(self.canCombineItemHere));